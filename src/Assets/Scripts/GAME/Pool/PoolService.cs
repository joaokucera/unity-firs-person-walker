...
namespace Assets.Scripts.GAME.Pool
{
    public class PoolService : IPoolService, IInitializable, IDisposable
    {
        ...
        GameObject GetPooledObjectInternal(string assetName, GameObject prefab, Transform parent = null)
        {
            ...
            {
#if UNITY_EDITOR
                pooledObject.transform.SetParent(_parentTransform, false);
#endif
            }
        ...
        public async Task<GameObject> GetPooledObjectAsync(AssetReference assetReference, Transform parent = null)
        {
            var prefab = await _addressableService.LoadAssetAsync<GameObject>(assetReference);
